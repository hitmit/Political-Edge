                                    ...
                                    @foreach ($expenses as $key => $expense)
                                        <tr>
                                            ...
                                            @else
                                                <td></td>
                                            @endif
                                            <td>{{ $expense->employee_category()->first()->category ?? '' }}</td>
                                            @if ($expense->type == 'income')
                                                <td>{{ $expense->amount }}</td>
                                            @else
                                                <td></td>
                                            @endif
                                            <td>{{ $expense->user()->first()->name ?? '' }}
                                            </td>
                                            <td>{{ $expense->date }}</td>
                                            <td>
                                                <form class="my-2"
                        ...
                        <div class="card-body">
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                <li class="nav-item mb-3 mr-2">
                                    <a class="nav-link active show" data-toggle="tab" href="#expenses" role="tab"
                                        aria-controls="expenses" aria-selected="true">Expense</a>
                                </li>
                                <li class="nav-item mb-3 mr-2">
                                    <a class="nav-link" data-toggle="tab" href="#advance" role="tab"
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" id="progress_data"
                                        class="form-control @error('progress_data') is-invalid @enderror" name="progress_data"
                                        value="{{ old('progress_data') }}">
