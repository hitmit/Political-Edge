...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        */
        ...
        $categories = EmployeeTransactionCategory::all();
        $employee_users = User::where('role', 'user')->get();

        return view('dashboard.index', compact('projects','categories', 'users', 'total_expense', 'total_income', "total_expected_revenue", "a3", "b3", "c3","total_amount_reduce","receiver_id", "total_internal",'employee_users'));
    }
